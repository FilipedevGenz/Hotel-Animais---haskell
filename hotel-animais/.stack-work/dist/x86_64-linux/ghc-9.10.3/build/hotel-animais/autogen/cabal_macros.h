...
/* package hotel-animais-0.1.0.0 */
#ifndef VERSION_hotel_animais
#define VERSION_hotel_animais "0.1.0.0"
#endif /* VERSION_hotel_animais */
#ifndef MIN_VERSION_hotel_animais
#define MIN_VERSION_hotel_animais(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_hotel_animais */
...
#define CURRENT_COMPONENT_ID "hotel-animais-0.1.0.0-7zYzt2usRSr266uQqax15M-hotel-animais"
